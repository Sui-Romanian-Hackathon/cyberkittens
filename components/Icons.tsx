...
export const SuiLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M16.5 30.5V11L7 17.5V36.5L16.5 30.5Z" fill="currentColor" fillOpacity="0.5"/>
    <path d="M16.5 11L26 4.5V23.5L16.5 30.5V11Z" fill="currentColor"/>
    <path d="M31.5 17.5V37L41 30.5V11.5L31.5 17.5Z" fill="currentColor" fillOpacity="0.5"/>
    <path d="M31.5 37L22 43.5V24.5L31.5 17.5V37Z" fill="currentColor"/>
  </svg>
);
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M9 4.5a.75.75 0 01.75.75v3.546a.75.75 0 01-1.5 0V5.25A.75.75 0 019 4.5zM12.75 8.663a.75.75 0 00-1.06 1.06l2.122 2.121a.75.75 0 001.06-1.06l-2.122-2.12zM18 9a.75.75 0 01.75.75v3.546a.75.75 0 01-1.5 0V9.75A.75.75 0 0118 9zM12.75 15.337a.75.75 0 00-1.06 1.06l2.122 2.121a.75.75 0 001.06-1.06l-2.122-2.12zM15 18a.75.75 0 01.75.75v3.546a.75.75 0 01-1.5 0V18.75A.75.75 0 0115 18zM6.28 14.22a.75.75 0 00-1.06-1.06l-2.121 2.12a.75.75 0 001.06 1.061l2.121-2.12zM6 9a.75.75 0 01.75.75v3.546a.75.75 0 01-1.5 0V9.75A.75.75 0 016 9zM20.121 14.22a.75.75 0 00-1.06-1.06l-2.121 2.12a.75.75 0 001.06 1.061l2.121-2.12z" clipRule="evenodd" />
    </svg>
);
